...
public class MinecraftLangSerializer {
    ...
    private final List<String> headComment = new ArrayList<>();
    ...
    public String toString() {
        ...
        if (!headComment.isEmpty()) {
            headComment.forEach((builder::append));
        }

        builder.append(N);

        maps.forEach((areaName, map) -> {
            if (!Objects.equals(areaName, "!")) builder.append("# ").append(areaName);
            builder.append(N);
